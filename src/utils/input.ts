import { Angle, Vector3 } from "../types/vector";
...
export const Input = {
  ...
  handleRotation(cameraRotation: Angle, lookSpeed: number) {
    ...
    if (cameraRotation.pitch > MAX_PITCH) cameraRotation.pitch = MAX_PITCH;
    if (cameraRotation.pitch < -MAX_PITCH) cameraRotation.pitch = -MAX_PITCH;
  },
